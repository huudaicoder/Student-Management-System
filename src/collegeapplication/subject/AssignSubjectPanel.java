...
// {
// this();
// condition=" where courcecode='"+fm.f.getCourceCode()+"' and
// semoryear="+fm.f.getSemorYear()+" ";
...
// {
// this();
// condition=" where courcecode='"+sm.s.getCourceCode()+"' and
// semoryear="+sm.s.getSemorYear()+" ";
// table.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
// this.createtablemodel();
