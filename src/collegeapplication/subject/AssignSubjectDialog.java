...
// lblImage.setIcon(new ImageIcon(f.getProfilePic(lblImage.getWidth(),
// lblImage.getHeight())));
...
// positioncombo.setModel(new DefaultComboBoxModel<String>(new String[] {
// "---Select Position---",
...
// label.setBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(192, 192,
// 192)));
// label.setBounds(0, 462, 505, 8);
// getContentPane().add(label);

// JLabel label_1 = new JLabel("");
// label_1.setBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(192, 192,
// 192)));
...
// courcenamecombo.setSelectedItem(new
// CourceData().getcourcename(f.getCourceCode()));
// semoryearcombo.setModel(new DefaultComboBoxModel<String>(
// new CourceData().getSemorYear(courcenamecombo.getSelectedItem() + "")));
// String[] totalsub = new SubjectData().getSubjectinCource(f.getCourceCode(),
// f.getSemorYear());
...
// semoryearcombo.setModel(new DefaultComboBoxModel<String>(new
// CourceData().getSemorYear(cource)));
// }
...
// String[] totalsub = new SubjectData().getSubjectinCource(new
// CourceData().getCourcecode(cource),
// semoryearcombo.getSelectedIndex());
// if (totalsub != null) {
// subjectnamecombo.setModel(new DefaultComboBoxModel<String>(totalsub));
// } else {
// subjectnamecombo.setModel(new DefaultComboBoxModel<String>(new String[] { "No
// Subject" }));
...
// fnew.setCourceCode(new
// CourceData().getCourcecode(courcenamecombo.getSelectedItem() + ""));
