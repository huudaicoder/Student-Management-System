...
public class UsersPanel extends JPanel {
		...
		table.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				if (e.getClickCount() > 1 && e.getButton() == MouseEvent.BUTTON1) {
					...
					} else if (userprofile.equals("Lecturer")) {
						String fid = (userid);
						Lecturer f = new LecturerData().getLecturerInfobyId(fid);
						am.viewlecturerpanel = new ViewLecturerPanel(f, am, am.userspanel);
	...
	// String Column[] = { "User Profile", "Class", "User id", "User name", "Login
	// Date", "Login Time" };
